...
```javascript
const API_BASE_URL = import.meta.env.VITE_API_URL || "https://careerconnect-backend-u91w.onrender.com";
export default API_BASE_URL;
```

### Update Hardcoded URLs
You should replace all remaining instances of `https://careerconnect-backend-u91w.onrender.com` in the `frontend/src` directory with `${API_BASE_URL}`. 

Example:
```javascript
// Before
axios.get("https://careerconnect-backend-u91w.onrender.com/api/v1/job/getall")
